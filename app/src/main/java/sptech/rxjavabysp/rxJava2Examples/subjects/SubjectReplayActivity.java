...
public class SubjectReplayActivity extends AppCompatActivity {


    private static final String TAG = "SubjectReplayActivity";
    ...
    void asyncOperator2() {
        ...
        ReplaySubject<String> asyncSubject = ReplaySubject.create();
